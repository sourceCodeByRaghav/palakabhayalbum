...
function Mehndi() {
  const fetchCompletePhotoAlbum = () => {
    window.open(
      "https://gallery.shivramlab.com/view/139m6t1kl3/abhay-palak/2-mehandi-bs-jpeg",
      "_blank"
    );
  };
    ...
    <div className="love-story-container">
      <div className="love-story-content">
        ...
        <p className="description">
          A vibrant celebration of love, tradition, and the beautiful art of
          mehndi that marks the beginning of our wedding festivities.
        </p>
